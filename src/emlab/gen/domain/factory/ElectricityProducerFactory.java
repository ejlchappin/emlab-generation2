...
public class ElectricityProducerFactory extends AbstractFactory {
    ...
    public ElectricityProducerFactory(Reps reps) {
        super(reps);
    }
    ...
    private void createPowerPlantsForMarket(ElectricitySpotMarket market) {
        ...
        for (PowerGeneratingTechnology technology : portfolioShares.keySet()) {
            ...
            while (requiredCapacityForTechnology > 0) {
                ...
                PowerPlant plant = getReps().createPowerPlantWithRandomAge(technology, energyProducer, getNodeForZone(market.getZone()));
    ...
    public static double determineLoanAnnuities(double totalLoan, double payBackTime, double interestRate) {
