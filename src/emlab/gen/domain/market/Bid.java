...
//    @RelatedTo(type = "BIDDER", elementClass = EMLabAgent.class, direction = Direction.INCOMING)
    private EMLabAgent bidder;
...
//    @Indexed(indexName = "bidTime")
    ...
    public EMLabAgent getBidder() {
        return bidder;
    }

    public void setBidder(EMLabAgent agent) {
        this.bidder = agent;
    }
