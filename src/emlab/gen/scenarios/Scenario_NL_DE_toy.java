 ...
 * @author ejlchappin
 */
public class Scenario_NL_DE_toy implements Scenario {
    ...
    public void build(Schedule schedule) {
        ...
        interconnectorNetherlandsGermany.setCapacity(100);
	...
	//Load duration curve
        ...
        ldcReader.setFilename("/data/ldcNLDE-toy.csv");
        ...
        powerPlantCSVFactory.setCsvFile("/data/dutchGermanPlants2015-toy.csv");
