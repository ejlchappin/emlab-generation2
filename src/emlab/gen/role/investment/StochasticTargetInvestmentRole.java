...
public class StochasticTargetInvestmentRole extends GenericInvestmentRole<StochasticTargetInvestor> {
    ...
    public StochasticTargetInvestmentRole(Schedule schedule) {
        super(schedule);
    }
    ...
    public void act(StochasticTargetInvestor targetInvestor) {
		...
		installationNode = getReps().findFirstPowerGridNodeByElectricitySpotMarket(targetInvestor.getInvestorMarket());
            ...
            PowerGeneratingTechnologyNodeLimit pgtLimit = getReps().findOneByTechnologyAndNode(pgt, installationNode);
            if (pgtLimit != null) {
            ...
            // targetInvestor + ", time: "
            // + futureTimePoint);
            double expectedDismantledPowerPlantCapacityOfTechnologyAndOwner = getReps().calculateCapacityOfExpectedDismantledPowerPlantsByOwnerByTechnology(futureTimePoint, targetInvestor, pgt);
