...
public class DCFinvestInPowerGenerationTechnologies<T extends EnergyProducer>
        extends GenericInvestmentRole<T> implements Role<T> {

    public DCFinvestInPowerGenerationTechnologies(Schedule schedule) {
        super(schedule);
    }
    ...
    SimpleRegression calculateRegressionBasedOnTimeStepsAndSubstance(long startTime, long endTime, Substance substance) {
        ...
        Iterable<ClearingPoint> clearingPoints = getReps().findAllClearingPointsForSubstanceAndTimeRange(substance,
