...
public class ReassignPowerPlantsToLongTermElectricityContractsRole extends
    ...
    public ReassignPowerPlantsToLongTermElectricityContractsRole(Schedule schedule) {
        super(schedule);
    }
    ...
    public void act(EnergyProducer producer) {
        ...
        for (LongTermContract ltc : getReps()
                ...
                if (index < nrOfLtcsToBeReplaced) {
                    if (getReps()
                        ...
                        if (plant.isWithinTechnicalLifetime(getCurrentTick())) {
                            ...
                            getReps().reassignLongTermContractToNewPowerPlant(
