...
public class SubmitLongTermElectricityContractsRole extends
        AbstractEnergyProducerRole<EnergyProducer> implements Role<EnergyProducer> {

    public SubmitLongTermElectricityContractsRole(Schedule schedule) {
        super(schedule);
    }
    ...
    public void act(EnergyProducer producer) {
        ...
        for (PowerPlant plant : getReps().findOperationalPowerPlantsByOwner(producer, getCurrentTick())) {
            ...
            if (getCurrentTick() > 0
                    ...
                    && getReps().findLongTermContractForPowerPlantActiveAtTime(
                ...
                for (LongTermContractType type : getReps().longTermContractTypes) {
                    ...
                    for (LongTermContractDuration duration : getReps().longTermContractDurations) {
                    ...
                    for (LongTermContractDuration duration : getReps().longTermContractDurations) {
                        ...
                        // contracts in the
                        LongTermContractOffer offer = getReps()
