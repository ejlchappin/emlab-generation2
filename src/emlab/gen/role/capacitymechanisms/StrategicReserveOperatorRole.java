...
public class StrategicReserveOperatorRole extends AbstractRole<StrategicReserveOperator> implements Role<StrategicReserveOperator> {
    ...
    public StrategicReserveOperatorRole(Schedule schedule) {
        super(schedule);
    }
    ...
    public void act(StrategicReserveOperator strategicReserveOperator) {
        ...
        double peakLoadforMarketNOtrend = getReps().peakLoadbyZoneMarketandTime(curZone, market);
        ...
        for (Segment currentSegment : getReps().segments) {
            ...
            for (PowerPlantDispatchPlan currentPPDP : getReps().findDescendingSortedPowerPlantDispatchPlansForSegmentForTime(currentSegment, getCurrentTick(),
                    false)) {
                ...
                if (currentPPDP.getBiddingMarket().equals(market)) {
